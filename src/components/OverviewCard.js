    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 w-full rounded-2xl bg-white [backface-visibility:hidden]">
          ...
          />
          <p className="absolute bottom-4 left-1/2 z-10 hidden -translate-x-1/2 text-bg md:flex">
            Hover to flip
          </p>
          <p className="absolute bottom-4 left-1/2 z-10 flex -translate-x-1/2 text-bg md:hidden">
            Click to flip
          </p>
        </div>

        {/* back side */}
        <div className="absolute inset-0 flex h-full w-full flex-col items-center justify-center gap-4 rounded-2xl bg-blue-400 p-4 [backface-visibility:hidden] [transform:rotateY(180deg)]">
          <p className="text-xl font-bold text-white md:text-3xl">Overview</p>
          <p className="text-justify text-bg md:text-lg">
